  ...
  return (
    <div className="min-h-screen bg-[#FAF8F4] dark:bg-[#0C0603] font-inter selection:bg-[#DF8142]/20 selection:text-white selection:bg-[#DF8142]/20 transition-colors duration-500 overflow-x-hidden">
      ...
      <section className="relative overflow-hidden pt-20 pb-16 lg:pt-32 lg:pb-20 bg-[#5A270F] border-b-4 border-[#DF8142]">
          ...
          <div className="flex flex-col lg:flex-row items-start gap-16">
            <div className="lg:w-3/5 space-y-6">
              <div className="inline-flex items-center gap-2 px-2 py-0.5 bg-[#EEB38C]/10 border border-[#EEB38C]/20 rounded-md text-[7px] font-black uppercase tracking-[0.4em] text-[#EEB38C] backdrop-blur-md">
                <Hexagon className="h-3 w-3 text-[#DF8142]" /> 
                NEXUS_CORE_IDENTITY_v5.0
              </div>
              ...
              <h1 className="text-4xl sm:text-7xl font-black text-white tracking-tighter leading-[0.85] italic drop-shadow-2xl font-space-grotesk">
                REDEFINING <br />
                <span className="text-[#DF8142] not-italic text-3xl sm:text-6xl uppercase">ARCHITECTURAL SHARE.</span>
              </h1>
              ...
              <div className="max-w-xl border-l-2 border-[#DF8142]/40 pl-4">
                <p className="text-[#EEB38C]/80 text-sm font-bold leading-tight uppercase tracking-tight">
                  ...
                  <span className="text-white"> CENTRALIZED REPOSITORY</span> ENGINEERED FOR STUDENTS, 
                  NURTURED BY FACULTY, AND SCALED FOR THE FUTURE.
                </p>
              </div>
            </div>
        ...
        {/* Technical Watermark */}
        <div className="absolute bottom-4 right-8 text-[12px] font-black text-white/5 uppercase tracking-[1.2em] select-none pointer-events-none font-mono">
          REGISTRY_STAMP_0x8C11
        </div>
      </section>
            ...
            <div className="relative z-10 grid lg:grid-cols-12 gap-12">
              <div className="lg:col-span-4 space-y-4">
                ...
                <p className="text-[10px] font-bold text-[#92664A] dark:text-white/20 uppercase tracking-widest leading-relaxed">
                  Engineered to bridge the gap between academic theory and technical implementation via shared intelligence.
                </p>
              </div>

              <div className="lg:col-span-8 grid grid-cols-1 md:grid-cols-2 gap-8">
                {[
                  { title: "Knowledge Parity", desc: "Universal access to top-tier BIM families and thesis protocols.", icon: Target },
                  { title: "Faculty Synergy", desc: "High-fidelity platform for distributing technical specifications.", icon: Users },
                  { title: "Metadata Integrity", desc: "Rigorous verification systems ensuring asset structural benchmarks.", icon: ShieldCheck },
                  { title: "Excellence Protocol", desc: "Reward-driven ecosystem for peer-validated high-performance assets.", icon: Award },
                ].map((item, i) => (
            ...
            <div className="lg:w-1/2 relative group">
              ...
              <div className="relative rounded-2xl overflow-hidden border border-white/10 shadow-3xl">
                ...
                <div className="absolute bottom-4 left-4 p-4 bg-black/40 backdrop-blur-md rounded-xl border border-white/10">
                  <p className="text-[#EEB38C] text-[7px] font-black uppercase tracking-[0.4em] mb-1">SYNERGY STATUS</p>
                  <h3 className="text-white text-xs font-black uppercase tracking-widest font-space-grotesk italic">FULLY_INTEGRATED</h3>
                </div>
              </div>
            </div>

            <div className="lg:w-1/2 space-y-8">
              <div className="inline-flex items-center gap-2 px-2 py-0.5 bg-[#EEB38C]/10 border border-[#EEB38C]/20 rounded-md text-[7px] font-black uppercase tracking-[0.4em] text-[#EEB38C]">
                DUAL_PERSPECTIVE_ENG
              </div>
              <h2 className="text-4xl sm:text-6xl font-black text-white tracking-tighter leading-[0.9] font-space-grotesk italic">
                ENGINEERED BY <br />
                <span className="text-[#DF8142] not-italic text-3xl sm:text-5xl">DUAL MATRICES.</span>
              </h2>
              <div className="space-y-6">
                ...
                <div className="grid sm:grid-cols-2 gap-6 pt-4">
                  <div className="p-4 bg-white/5 rounded-xl border border-white/5 space-y-2">
                    <h4 className="text-[#EEB38C] font-black uppercase tracking-widest text-[8px]">Architecture Students</h4>
                    <p className="text-white/30 text-[9.5px] font-bold leading-tight uppercase tracking-tight">
                      Defining spatial logic, resource criticality, and professional benchmarks.
                    </p>
                  </div>
                  <div className="p-4 bg-[white/5 rounded-xl border border-white/5 space-y-2">
                    <h4 className="text-[#DF8142] font-black uppercase tracking-widest text-[8px]">Software Students</h4>
                    <p className="text-white/30 text-[9.5px] font-bold leading-tight uppercase tracking-tight">
                      Implementing high-performance systems and secure distribution nodes.
                    </p>
                  </div>
                </div>
              </div>
      ...
      <section className="py-20 relative overflow-hidden">
        ...
        <div className="max-w-6xl mx-auto px-6 relative z-10">
          <div className="flex flex-col items-center text-center mb-16">
            <div className="inline-flex items-center gap-2 px-3 py-1 bg-[#DF8142]/10 border border-[#DF8142]/20 rounded-full text-[8px] font-black uppercase tracking-[0.4em] text-[#DF8142] mb-6">
              <Award className="h-3 w-3" /> MILESTONE_REPOSITORY
            </div>
            <h2 className="text-3xl md:text-5xl font-black text-[#5A270F] dark:text-[#EEB38C] tracking-tighter leading-none mb-4 font-space-grotesk uppercase italic">
              THE WOLLO UNIVERSITY <span className="text-[#DF8142] not-italic">LEGACY.</span>
            </h2>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
            {[
              ...
              >
                <div className={`absolute -top-3 left-6 h-8 w-8 rounded-lg flex items-center justify-center font-black text-[10px] shadow-lg ${
                   item.featured ? 'bg-[#DF8142] text-white' : 'bg-[#5A270F] text-[#EEB38C]'
                }`}>{item.id}</div>
                
                <p className={`text-[7px] font-black uppercase tracking-[0.4em] mb-4 ${item.featured ? 'text-[#EEB38C]' : 'text-[#DF8142]'}`}>
                  {item.tag}
                </p>
                ...
                <p className={`text-[10px] font-bold leading-tight uppercase tracking-tight mb-8 ${item.featured ? 'text-white/60' : 'text-[#5A270F]/60 dark:text-[#EEB38C]/40'}`}>
                  {item.desc}
                </p>
                
                <div className={`flex items-center gap-3 pt-4 border-t ${item.featured ? 'border-white/10' : 'border-[#D9D9C2]/20 dark:border-white/5'}`}>
                   <item.icon className={`h-3.5 w-3.5 ${item.featured ? 'text-[#DF8142]' : 'text-[#92664A]'}`} />
                   <span className={`text-[8px] font-black tracking-widest uppercase ${item.featured ? 'text-white' : 'text-[#5A270F] dark:text-[#EEB38C]'}`}>
                     {item.date}
                   </span>
                </div>
              </div>
      ...
      <section className="py-20 bg-white dark:bg-[#1A0100]/40 relative overflow-hidden border-t-2 border-[#D9D9C2]/20">
        <div className="absolute right-0 top-0 p-8 text-[80px] font-black text-[#5A270F]/5 rotate-12 select-none pointer-events-none font-space-grotesk">CDN</div>
        <div className="max-w-4xl mx-auto px-6 text-center space-y-8">
           <div className="inline-flex items-center gap-3 px-4 py-1.5 bg-[#FAF8F4] dark:bg-black/20 border border-[#D9D9C2] dark:border-white/10 rounded-full text-[8px] font-black uppercase tracking-[0.4em] text-[#5A270F] dark:text-[#EEB38C]">
              <Sparkles className="h-3 w-3 text-[#DF8142]" /> FUTURE_STRATEGY
           </div>
           ...
           <h2 className="text-3xl md:text-5xl font-black text-[#5A270F] dark:text-white tracking-tighter leading-[0.9] font-space-grotesk uppercase italic">
             TOWARDS A GLOBAL <br />
             <span className="text-[#DF8142] not-italic italic">ARCHITECTURAL CDN.</span>
           </h2>
           ...
           <p className="text-xs text-[#5A270F]/80 dark:text-[#EEB38C]/60 font-bold leading-relaxed uppercase tracking-tight max-w-2xl mx-auto italic">
              WE ARE BUILDING A CONTENT DELIVERY NETWORK OPTIMIZED FOR HEAVY ARCHITECTURAL FORMATS—RFA, SKP, DWG, AND HI-RES PDFS. AUTOMATED BIM VALIDATION AND AI-TAGGING NODES ARE ACTIVE IN ROADMAP STAGE.
           </p>
           ...
           <div className="flex flex-col sm:flex-row items-center justify-center gap-4 pt-4">
              ...
              >
                JOIN_THE_NETWORK <ArrowRight className="h-3.5 w-3.5 group-hover:translate-x-1" />
              </Link>
           </div>
        </div>
      </section>
