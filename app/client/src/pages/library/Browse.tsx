...
const Browse = () => {
    ...
    const fetchResources = useCallback(async (filters: FilterState) => {
        ...
        try {
            ...
            setError('An error occurred while loading resources. Please try again later.');
            setResources([]);
        } finally {
            setLoading(false);
        }
    ...
    return (
        <div className="container mx-auto px-4 sm:px-6 lg:px-8 py-8">
            <div className="mb-8 text-center">
                ...
                <p className="mt-2 text-lg text-gray-600">Find the materials you need for your next project.</p>
            </div>
            ...
            <div className="mt-8">
                {loading ? (
                    <div className="flex flex-col items-center justify-center text-center py-20">
                        ...
                        <p className="mt-4 text-lg font-medium text-gray-600">Loading Resources...</p>
                    </div>
                ) : error ? (
                    ...
                    <div className="text-center py-20 bg-white rounded-lg shadow-sm border">
                        <h3 className="text-xl font-medium text-gray-800">No Resources Found</h3>
