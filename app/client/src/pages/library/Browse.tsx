    ...
    <div className="min-h-screen bg-white">
      ...
      <div className="relative pt-32 pb-20 overflow-hidden bg-slate-950">
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10 text-center">
          <div className="inline-flex items-center gap-2 px-3 py-1 bg-indigo-500/10 border border-indigo-500/20 rounded-full text-[10px] font-bold uppercase tracking-widest text-indigo-400 mb-6 animate-in fade-in slide-in-from-top-4 duration-700">
          ...
          <p className="max-w-xl mx-auto text-slate-400 text-base sm:text-lg font-medium leading-relaxed">
          ...
          {loading ? (
            <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4 gap-8">
              {[...Array(8)].map((_, i) => (
                <div
                  key={i}
                  className="bg-slate-50 h-[400px] rounded-3xl animate-pulse border border-slate-100"
                />
              ))}
            </div>
          ) : error ? (
            ...
            <div className="text-center py-24 bg-slate-50 rounded-3xl border border-slate-100 border-dashed">
              ...
              <button
                onClick={() => fetchResources({})}
                className="mt-6 text-indigo-600 font-bold text-[10px] uppercase tracking-widest hover:text-slate-900 transition-colors"
              >
