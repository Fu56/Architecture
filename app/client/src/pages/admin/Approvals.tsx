        ...
        <div className="relative z-10 w-full flex flex-col md:flex-row md:items-center justify-between items-start gap-6">
          <div className="space-y-1.5">
            <div className="flex items-center gap-2.5">
              ...
              <p className="text-[8px] font-black text-[#EEB38C] uppercase tracking-[0.5em]">ADMINISTRATIVE NEXUS</p>
            </div>
            ...
            <p className="text-[9px] lg:text-[10px] text-[#EEB38C]/60 font-medium max-w-lg leading-relaxed uppercase tracking-wider">
              Diagnostic overview of pending architectural intelligence nodes. authorize global deployment protocols.
            </p>
          </div>
          ...
          <div className="flex items-center gap-4 bg-black/40 backdrop-blur-2xl px-6 py-3 rounded-[1.5rem] border border-white/10 shadow-xl">
            ...
            <div>
              ...
              <p className="text-[6px] font-black text-[#EEB38C]/40 uppercase tracking-[0.4em] mt-0.5">PENDING UNITS</p>
            </div>
          </div>
        </div>
      </div>
                   ...
                   <div className="space-y-4">
                      <div className="flex flex-wrap items-center gap-3">
                        <div className="flex items-center gap-2 px-3 py-1 bg-[#5A270F] text-[#EEB38C] rounded-lg shadow-md border border-white/5 group/proto hover:-translate-y-0.5 transition-all">
                          ...
                          <span className="text-[8px] font-black uppercase tracking-[0.1em]">
                            {((resource as any).fileType || 'Asset').toUpperCase()} <span className="text-white/40 italic ml-2">PR-0{resource.id % 9 + 1}</span>
                          </span>
                        </div>
                      ...
                      <div className="flex flex-wrap items-center gap-4">
                        <div className="flex items-center gap-3 p-2.5 bg-[#6C3B1C]/5 dark:bg-white/5 rounded-xl border border-[#6C3B1C]/10 dark:border-white/10 group/item hover:bg-white dark:hover:bg-[#1A0B04] transition-all duration-500 shadow-sm">
                          ...
                          <div>
                            <p className="text-[6px] font-black text-[#6C3B1C]/60 dark:text-[#EEB38C]/40 uppercase tracking-[0.3em] mb-0.5">AUTHORITY</p>
                        ...
                        <div className="flex items-center gap-3 p-2.5 bg-[#6C3B1C]/5 dark:bg-white/5 rounded-xl border border-[#6C3B1C]/10 dark:border-white/10 group/item hover:bg-white dark:hover:bg-[#1A0B04] transition-all duration-500 shadow-sm">
                          ...
                          <div>
                            <p className="text-[6px] font-black text-[#6C3B1C]/60 dark:text-[#EEB38C]/40 uppercase tracking-[0.3em] mb-0.5">STATION</p>
                            <p className="text-[9px] font-black text-[#5A270F] dark:text-white uppercase tracking-tight">
                ...
                <div className="lg:col-span-4 mt-6 lg:mt-0 flex flex-col gap-4 lg:sticky lg:top-10">
                   <div className="bg-[#5A270F] dark:bg-black p-6 rounded-[2rem] border border-white/5 shadow-2xl shadow-[#5A270F]/30 space-y-4 relative overflow-hidden group/card">
                      ...
                      <div className="flex items-center gap-2.5 border-b border-white/10 pb-3">
                        ...
                        <span className="text-[9px] font-black text-white uppercase tracking-[0.3em]">DATA TELEMETRY</span>
                      </div>
                      
                      <div className="space-y-3">
                        <div className="flex justify-between items-center group/log">
                          <span className="text-[7px] font-black text-[#EEB38C]/50 uppercase tracking-widest">STRUCTURE</span>
                          <span className="px-2 py-0.5 bg-emerald-500/20 text-emerald-400 rounded-md text-[7px] font-black tracking-[0.1em] border border-emerald-500/10 hover:scale-105 transition-transform">VERIFIED</span>
                        </div>
                        <div className="flex justify-between items-center group/log">
                          <span className="text-[7px] font-black text-[#EEB38C]/50 uppercase tracking-widest">CLEARANCE</span>
                          <span className="text-[8px] font-black text-white block uppercase italic tracking-widest">ARCH-LEVEL</span>
                        </div>
                        <div className="flex justify-between items-center group/log">
                          <span className="text-[7px] font-black text-[#EEB38C]/50 uppercase tracking-widest">BIM MATCH</span>
                          <span className="text-emerald-400 font-mono text-[9px]">98.4%</span>
                        </div>
                      </div>
                   </div>
                   ...
                   <div className="flex flex-col gap-2">
                      ...
                      <div className="grid grid-cols-2 gap-2 h-10">
                         ...
                         >
                           <X className="h-3.5 w-3.5" /> {isDeptHead ? "REJECT" : "PROPOSE"}
                         </button>
                         <button
                         ...
                         >
                           <Check className="h-3.5 w-3.5" /> {isDeptHead ? "DEPLOY" : "APPROVE"}
                         </button>
                      </div>
                   </div>
                </div>
