    ...
    >
      ...
      {!isSettingsPage && (
        <>
          ...
          <aside
            className={`fixed lg:relative inset-y-0 left-0 z-50 lg:z-auto w-64 lg:w-64 flex flex-col gap-4 p-4 lg:p-0 bg-white dark:bg-card dark:bg-[#1A0B04] lg:bg-transparent lg:dark:bg-transparent transform transition-all duration-500 ease-in-out ${
          ...
          >
            <div className="bg-gradient-to-b from-[#5A270F] via-[#6C3B1C] to-[#2A1205] dark:from-[#1A0B04] dark:to-black rounded-[2rem] p-6 text-white relative overflow-hidden flex flex-col gap-6 shadow-2xl shadow-black/10 dark:shadow-none border border-white/5 h-full lg:h-auto min-h-[85vh] transition-colors duration-500">
                ...
                <nav className="space-y-1.5">
                  {[
                    ...
                    <NavLink
                      ...
                      to={item.to}
                      className={({ isActive }) =>
                        `flex items-center gap-3 px-5 py-3 rounded-xl text-[9.5px] font-black uppercase tracking-[0.15em] transition-all group ${
                          isActive
