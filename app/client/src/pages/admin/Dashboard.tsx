        ...
        <aside className="md:col-span-3 lg:col-span-3 xl:col-span-2 mb-8 md:mb-0 sticky top-24">
          <div className="bg-white rounded-3xl border border-gray-100 shadow-xl shadow-gray-200/50 p-6 space-y-8">
            ...
            <div className="flex flex-col items-center text-center pb-6 border-b border-gray-50">
              <div className="h-20 w-20 rounded-2xl bg-gradient-to-br from-indigo-600 to-indigo-900 flex items-center justify-center text-white text-2xl font-black shadow-lg mb-4 ring-4 ring-indigo-50">
                {user?.first_name?.[0]}
                {user?.last_name?.[0]}
              </div>
              ...
              <p className="text-xs font-bold text-indigo-600 uppercase tracking-widest mt-2 bg-indigo-50 px-3 py-1 rounded-full border border-indigo-100">
