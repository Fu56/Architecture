...
import type { Resource, User as PrismaUser } from '@prisma/client';

interface ResourceCardProps {
    resource: Resource & { uploader?: PrismaUser | null }; // include uploader relation if you fetch it
}
...
const ResourceCard = ({ resource }: ResourceCardProps) => {
    ...
    const typeStyle =
        fileType && fileTypeStyles[fileType.toLowerCase()] || fileTypeStyles.default;
          ...
          >
            {fileType}
                ...
                <div className="flex items-center text-sm text-gray-500 mb-4">
                    ...
                    <span>{author || uploader?.firstName + ' ' + uploader?.lastName}</span>
                </div>
