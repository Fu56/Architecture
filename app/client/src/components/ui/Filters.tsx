    ...
    <div className="w-full max-w-5xl mx-auto space-y-4">
      <div className="flex flex-col md:flex-row items-stretch md:items-center gap-4">
        ...
        <div className="relative flex-grow group">
          <div className="absolute -inset-0.5 bg-primary/90 rounded-xl blur opacity-10 group-focus-within:opacity-20 transition duration-500" />
          <div className="relative flex items-center bg-white border border-[#D9D9C2] rounded-xl overflow-hidden shadow-sm group-focus-within:border-primary/80 group-focus-within:shadow-primary/5 transition-all">
        ...
        <button
          ...
          className={`flex items-center justify-center gap-3 px-6 py-3.5 rounded-xl font-bold uppercase tracking-widest text-[10px] transition-all duration-300 border-2 ${
            showFilters || activeFilterCount > 0
              ...
              : "bg-white text-[#5A270F]/80 border-[#D9D9C2] hover:border-primary/40"
          }`}
        >
          <SlidersHorizontal className="h-4 w-4" />
          <span>Refine Space</span>
          {activeFilterCount > 0 && (
            <span className="ml-1 bg-white text-primary px-2 py-0.5 rounded-full text-[10px]">
              {activeFilterCount}
            </span>
          )}
          <ChevronDown
          ...
          <div className="bg-[#EFEDED] border border-[#D9D9C2] rounded-2xl p-6 space-y-6">
            <div className="flex items-center justify-between">
              ...
              <button
                ...
                className="text-[10px] font-bold uppercase tracking-widest text-primary hover:text-primary/90 transition-colors"
              >
                Reset Matrix
              </button>
            </div>
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6">
              <div className="space-y-1.5">
                ...
                <select
                  ...
                  onChange={handleInputChange}
                  className="w-full px-4 py-3 bg-white border border-[#D9D9C2] rounded-lg font-bold text-slate-700 focus:ring-2 focus:ring-primary/90 outline-none appearance-none cursor-pointer"
                >
              ...
              <div className="space-y-2">
                ...
                <div className="grid grid-cols-2 gap-4">
                  <input
                    ...
                    value={filters.year || ""}
                    onChange={handleInputChange}
                    className="w-full px-4 py-3 bg-white border border-[#D9D9C2] rounded-lg font-bold text-slate-700 outline-none focus:ring-2 focus:ring-primary/90"
                  />
                  <input
                    type="number"
                    name="semester"
